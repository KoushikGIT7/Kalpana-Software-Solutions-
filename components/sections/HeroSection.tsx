  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-8 lg:px-12 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8 py-10 lg:py-24 min-h-[600px]">
          {/* Left: Text (60%) */}
          <div className="flex-1 lg:max-w-[58%] flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-2 mt-4">
              ...
              <Link
                href="/#founder"
                className="inline-flex items-center gap-2 rounded-full border border-[var(--border-accent)] hover:border-[var(--accent)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] font-bold text-xs uppercase tracking-widest px-7 py-4 transition-all duration-150 hover:-translate-y-0.5 bg-[var(--bg-surface1)]"
                style={{ letterSpacing: '0.06em' }}
              >
